...
def subset_USA_reduced_damages(
    ...
    US_territories = ["USA", "XBK", "GUM", "XHO", "XJV", "XJA", "XKR", "XMW", "XNV", "MNP", "XPL", "PRI", "VIR", "XWK"]
    subset = ds.sel(region=[i for i in ds.region.values if any(j in i for j in US_territories)])
...
def subset_USA_ssp_econ(
    ...
    US_territories = ["USA", "XBK", "GUM", "XHO", "XJV", "XJA", "XKR", "XMW", "XNV", "MNP", "XPL", "PRI", "VIR", "XWK"]
    zarr = zarr.sel(region=[i for i in zarr.region.values if any(j in i for j in US_territories)])
